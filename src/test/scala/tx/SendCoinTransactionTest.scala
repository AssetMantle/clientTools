...
class SendCoinTransactionTest extends AnyFunSuite {
  ...
  val seq = 6 //utilities.Account.getSequenceAndAccountNumber(testConstants.setup.balanceAccount.address)
  ...
  val txHash: String = utilities.Encoding.sha256HashHexString(txRawBytes)
