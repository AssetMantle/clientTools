...
class DefineMembership extends AnyFunSuite {
  ...
  val immutableMetaProperties: Seq[MetaProperty] = Seq(
    ...
    MetaProperty(id = PropertyID(keyID = StringID("category"), typeID = schema.data.constants.NumberDataTypeID), data = NumberData(0)),
//    MetaProperty(id = PropertyID(keyID = StringID("tier"), typeID = schema.data.constants.NumberDataTypeID), data = NumberData(0)),
//    MetaProperty(id = PropertyID(keyID = StringID("points"), typeID = schema.data.constants.NumberDataTypeID), data = NumberData(0)),
