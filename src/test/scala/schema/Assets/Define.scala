...
class Define extends AnyFunSuite {
  ...
  val immutableMetaProperties: Seq[MetaProperty] = Seq(
    ...
    MetaProperty(PropertyID(StringID("AssetIM5"), constants.Data.ListDataTypeID), ListData(Seq())),
    MetaProperty(PropertyID(StringID("AssetIM6"), constants.Data.NumberDataTypeID), NumberData(0)),
    MetaProperty(PropertyID(StringID("AssetIM7"), constants.Data.StringDataTypeID), StringData("")),
  )
  ...
  val immutableProperties: Seq[MesaProperty] = Seq(
    ...
    MesaProperty(PropertyID(StringID("AssetI3"), constants.Data.DecDataTypeID), DecData("0")),
  ...
  val mutableMetaProperties: Seq[MetaProperty] = Seq(
    MetaProperty(PropertyID(StringID("AssetMM1"), constants.Data.AccAddressDataTypeID), AccAddressData(testConstants.setup.balanceAccount.address)),
    MetaProperty(PropertyID(StringID("AssetMM2"), constants.Data.BooleanDataTypeID), BooleanData(false)),
    MetaProperty(PropertyID(StringID("AssetMM3"), constants.Data.DecDataTypeID), DecData("0")),
    MetaProperty(PropertyID(StringID("AssetMM4"), constants.Data.HeightDataTypeID), HeightData(Height(-1))),
    MetaProperty(PropertyID(StringID("AssetMM5"), constants.Data.ListDataTypeID), ListData(Seq())),
    MetaProperty(PropertyID(StringID("AssetMM6"), constants.Data.NumberDataTypeID), NumberData(0)),
    MetaProperty(PropertyID(StringID("AssetMM7"), constants.Data.StringDataTypeID), StringData("")),
  )
  val mutableProperties: Seq[MesaProperty] = Seq(
    ...
    MesaProperty(PropertyID(StringID("AssetM3"), constants.Data.DecDataTypeID), DecData("0")),
