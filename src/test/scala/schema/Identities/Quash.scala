...
class Quash extends AnyFunSuite {
  val identitiesQuashMsg = utilities.BlockchainTransaction.getQuashIdentityMsgAsAny(testConstants.setup.balanceAccount.address, testConstants.setup.identityID.asProtoIdentityID, testConstants.setup.secondaryIdentityID.asProtoIdentityID)
