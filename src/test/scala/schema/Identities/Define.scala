...
class Define extends AnyFunSuite {
  ...
  val immutableMetaProperties: Seq[MetaProperty] = Seq(
    ...
    MetaProperty(PropertyID(StringID("IdentityIM5"), constants.Data.ListDataTypeID), ListData(Seq())),
    MetaProperty(PropertyID(StringID("IdentityIM6"), constants.Data.NumberDataTypeID), NumberData(0)),
    MetaProperty(PropertyID(StringID("IdentityIM7"), constants.Data.StringDataTypeID), StringData("")),
  )
  ...
  val immutableProperties: Seq[MesaProperty] = Seq(
    ...
    MesaProperty(PropertyID(StringID("IdentityI3"), constants.Data.DecDataTypeID), DecData("0")),
  ...
  val mutableMetaProperties: Seq[MetaProperty] = Seq(
    MetaProperty(PropertyID(StringID("IdentityMM1"), constants.Data.AccAddressDataTypeID), AccAddressData(testConstants.setup.balanceAccount.address)),
    MetaProperty(PropertyID(StringID("IdentityMM2"), constants.Data.BooleanDataTypeID), BooleanData(false)),
    MetaProperty(PropertyID(StringID("IdentityMM3"), constants.Data.DecDataTypeID), DecData("0")),
    MetaProperty(PropertyID(StringID("IdentityMM4"), constants.Data.HeightDataTypeID), HeightData(Height(-1))),
    MetaProperty(PropertyID(StringID("IdentityMM5"), constants.Data.ListDataTypeID), ListData(Seq())),
    MetaProperty(PropertyID(StringID("IdentityMM6"), constants.Data.NumberDataTypeID), NumberData(0)),
    MetaProperty(PropertyID(StringID("IdentityMM7"), constants.Data.StringDataTypeID), StringData("")),
  )
  val mutableProperties: Seq[MesaProperty] = Seq(
    ...
    MesaProperty(PropertyID(StringID("IdentityM3"), constants.Data.DecDataTypeID), DecData("0")),
