...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_ibc_core_channel_v1_QueryChannelClientStateRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_ibc_core_channel_v1_QueryChannelClientStateRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryChannelClientStateRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryChannelClientStateRequest other = (QueryChannelClientStateRequest) obj;
  ...
  public static QueryChannelClientStateRequest parseFrom(
  ...
  public static QueryChannelClientStateRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryChannelClientStateRequest parseFrom(
  ...
  public static QueryChannelClientStateRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryChannelClientStateRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryChannelClientStateRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryChannelClientStateRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public QueryChannelClientStateRequest build() {
      QueryChannelClientStateRequest result = buildPartial();
    ...
    public QueryChannelClientStateRequest buildPartial() {
      QueryChannelClientStateRequest result = new QueryChannelClientStateRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryChannelClientStateRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryChannelClientStateRequest) {
        return mergeFrom((QueryChannelClientStateRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryChannelClientStateRequest other) {
      if (other == QueryChannelClientStateRequest.getDefaultInstance()) return this;
  ...
  private static final QueryChannelClientStateRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryChannelClientStateRequest();
  }
