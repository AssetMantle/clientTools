...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_ibc_core_channel_v1_QueryChannelClientStateResponse_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_ibc_core_channel_v1_QueryChannelClientStateResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryChannelClientStateResponse.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryChannelClientStateResponse other = (QueryChannelClientStateResponse) obj;
  ...
  public static QueryChannelClientStateResponse parseFrom(
  ...
  public static QueryChannelClientStateResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryChannelClientStateResponse parseFrom(
  ...
  public static QueryChannelClientStateResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryChannelClientStateResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryChannelClientStateResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryChannelClientStateResponse prototype) {
  ...
  public static final class Builder extends
    ...
    public QueryChannelClientStateResponse build() {
      QueryChannelClientStateResponse result = buildPartial();
    ...
    public QueryChannelClientStateResponse buildPartial() {
      QueryChannelClientStateResponse result = new QueryChannelClientStateResponse(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryChannelClientStateResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryChannelClientStateResponse) {
        return mergeFrom((QueryChannelClientStateResponse)other);
      } else {
    ...
    public Builder mergeFrom(QueryChannelClientStateResponse other) {
      if (other == QueryChannelClientStateResponse.getDefaultInstance()) return this;
  ...
  private static final QueryChannelClientStateResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryChannelClientStateResponse();
  }
