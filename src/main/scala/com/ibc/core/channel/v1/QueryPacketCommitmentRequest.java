...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_ibc_core_channel_v1_QueryPacketCommitmentRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_ibc_core_channel_v1_QueryPacketCommitmentRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryPacketCommitmentRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryPacketCommitmentRequest other = (QueryPacketCommitmentRequest) obj;
  ...
  public static QueryPacketCommitmentRequest parseFrom(
  ...
  public static QueryPacketCommitmentRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryPacketCommitmentRequest parseFrom(
  ...
  public static QueryPacketCommitmentRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryPacketCommitmentRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryPacketCommitmentRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryPacketCommitmentRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public QueryPacketCommitmentRequest build() {
      QueryPacketCommitmentRequest result = buildPartial();
    ...
    public QueryPacketCommitmentRequest buildPartial() {
      QueryPacketCommitmentRequest result = new QueryPacketCommitmentRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryPacketCommitmentRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryPacketCommitmentRequest) {
        return mergeFrom((QueryPacketCommitmentRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryPacketCommitmentRequest other) {
      if (other == QueryPacketCommitmentRequest.getDefaultInstance()) return this;
  ...
  private static final QueryPacketCommitmentRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryPacketCommitmentRequest();
  }
