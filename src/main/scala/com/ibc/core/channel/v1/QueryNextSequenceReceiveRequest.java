...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_ibc_core_channel_v1_QueryNextSequenceReceiveRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_ibc_core_channel_v1_QueryNextSequenceReceiveRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryNextSequenceReceiveRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryNextSequenceReceiveRequest other = (QueryNextSequenceReceiveRequest) obj;
  ...
  public static QueryNextSequenceReceiveRequest parseFrom(
  ...
  public static QueryNextSequenceReceiveRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryNextSequenceReceiveRequest parseFrom(
  ...
  public static QueryNextSequenceReceiveRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryNextSequenceReceiveRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryNextSequenceReceiveRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryNextSequenceReceiveRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public QueryNextSequenceReceiveRequest build() {
      QueryNextSequenceReceiveRequest result = buildPartial();
    ...
    public QueryNextSequenceReceiveRequest buildPartial() {
      QueryNextSequenceReceiveRequest result = new QueryNextSequenceReceiveRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryNextSequenceReceiveRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryNextSequenceReceiveRequest) {
        return mergeFrom((QueryNextSequenceReceiveRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryNextSequenceReceiveRequest other) {
      if (other == QueryNextSequenceReceiveRequest.getDefaultInstance()) return this;
  ...
  private static final QueryNextSequenceReceiveRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryNextSequenceReceiveRequest();
  }
