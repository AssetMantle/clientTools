...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_ibc_core_channel_v1_QueryPacketAcknowledgementResponse_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_ibc_core_channel_v1_QueryPacketAcknowledgementResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryPacketAcknowledgementResponse.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryPacketAcknowledgementResponse other = (QueryPacketAcknowledgementResponse) obj;
  ...
  public static QueryPacketAcknowledgementResponse parseFrom(
  ...
  public static QueryPacketAcknowledgementResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryPacketAcknowledgementResponse parseFrom(
  ...
  public static QueryPacketAcknowledgementResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryPacketAcknowledgementResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryPacketAcknowledgementResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryPacketAcknowledgementResponse prototype) {
  ...
  public static final class Builder extends
    ...
    public QueryPacketAcknowledgementResponse build() {
      QueryPacketAcknowledgementResponse result = buildPartial();
    ...
    public QueryPacketAcknowledgementResponse buildPartial() {
      QueryPacketAcknowledgementResponse result = new QueryPacketAcknowledgementResponse(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryPacketAcknowledgementResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryPacketAcknowledgementResponse) {
        return mergeFrom((QueryPacketAcknowledgementResponse)other);
      } else {
    ...
    public Builder mergeFrom(QueryPacketAcknowledgementResponse other) {
      if (other == QueryPacketAcknowledgementResponse.getDefaultInstance()) return this;
  ...
  private static final QueryPacketAcknowledgementResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryPacketAcknowledgementResponse();
  }
