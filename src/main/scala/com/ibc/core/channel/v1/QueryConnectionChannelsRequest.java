...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_ibc_core_channel_v1_QueryConnectionChannelsRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_ibc_core_channel_v1_QueryConnectionChannelsRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryConnectionChannelsRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryConnectionChannelsRequest other = (QueryConnectionChannelsRequest) obj;
  ...
  public static QueryConnectionChannelsRequest parseFrom(
  ...
  public static QueryConnectionChannelsRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryConnectionChannelsRequest parseFrom(
  ...
  public static QueryConnectionChannelsRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryConnectionChannelsRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryConnectionChannelsRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryConnectionChannelsRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public QueryConnectionChannelsRequest build() {
      QueryConnectionChannelsRequest result = buildPartial();
    ...
    public QueryConnectionChannelsRequest buildPartial() {
      QueryConnectionChannelsRequest result = new QueryConnectionChannelsRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryConnectionChannelsRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryConnectionChannelsRequest) {
        return mergeFrom((QueryConnectionChannelsRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryConnectionChannelsRequest other) {
      if (other == QueryConnectionChannelsRequest.getDefaultInstance()) return this;
  ...
  private static final QueryConnectionChannelsRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryConnectionChannelsRequest();
  }
