...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_ibc_core_connection_v1_QueryConnectionConsensusStateResponse_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_ibc_core_connection_v1_QueryConnectionConsensusStateResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryConnectionConsensusStateResponse.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryConnectionConsensusStateResponse other = (QueryConnectionConsensusStateResponse) obj;
  ...
  public static QueryConnectionConsensusStateResponse parseFrom(
  ...
  public static QueryConnectionConsensusStateResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryConnectionConsensusStateResponse parseFrom(
  ...
  public static QueryConnectionConsensusStateResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryConnectionConsensusStateResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryConnectionConsensusStateResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryConnectionConsensusStateResponse prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public QueryConnectionConsensusStateResponse getDefaultInstanceForType() {
      return QueryConnectionConsensusStateResponse.getDefaultInstance();
    }

    @Override
    public QueryConnectionConsensusStateResponse build() {
      QueryConnectionConsensusStateResponse result = buildPartial();
    ...
    public QueryConnectionConsensusStateResponse buildPartial() {
      QueryConnectionConsensusStateResponse result = new QueryConnectionConsensusStateResponse(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryConnectionConsensusStateResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryConnectionConsensusStateResponse) {
        return mergeFrom((QueryConnectionConsensusStateResponse)other);
      } else {
    ...
    public Builder mergeFrom(QueryConnectionConsensusStateResponse other) {
      if (other == QueryConnectionConsensusStateResponse.getDefaultInstance()) return this;
  ...
  private static final QueryConnectionConsensusStateResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryConnectionConsensusStateResponse();
  }
