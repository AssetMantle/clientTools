...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_ibc_core_connection_v1_QueryClientConnectionsRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_ibc_core_connection_v1_QueryClientConnectionsRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryClientConnectionsRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryClientConnectionsRequest other = (QueryClientConnectionsRequest) obj;
  ...
  public static QueryClientConnectionsRequest parseFrom(
  ...
  public static QueryClientConnectionsRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryClientConnectionsRequest parseFrom(
  ...
  public static QueryClientConnectionsRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryClientConnectionsRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryClientConnectionsRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryClientConnectionsRequest prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public QueryClientConnectionsRequest getDefaultInstanceForType() {
      return QueryClientConnectionsRequest.getDefaultInstance();
    }

    @Override
    public QueryClientConnectionsRequest build() {
      QueryClientConnectionsRequest result = buildPartial();
    ...
    public QueryClientConnectionsRequest buildPartial() {
      QueryClientConnectionsRequest result = new QueryClientConnectionsRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryClientConnectionsRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryClientConnectionsRequest) {
        return mergeFrom((QueryClientConnectionsRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryClientConnectionsRequest other) {
      if (other == QueryClientConnectionsRequest.getDefaultInstance()) return this;
  ...
  private static final QueryClientConnectionsRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryClientConnectionsRequest();
  }
