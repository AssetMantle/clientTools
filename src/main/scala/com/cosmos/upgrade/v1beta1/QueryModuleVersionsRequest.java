...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_cosmos_upgrade_v1beta1_QueryModuleVersionsRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_cosmos_upgrade_v1beta1_QueryModuleVersionsRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryModuleVersionsRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryModuleVersionsRequest other = (QueryModuleVersionsRequest) obj;
  ...
  public static QueryModuleVersionsRequest parseFrom(
  ...
  public static QueryModuleVersionsRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryModuleVersionsRequest parseFrom(
  ...
  public static QueryModuleVersionsRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryModuleVersionsRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryModuleVersionsRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryModuleVersionsRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public QueryModuleVersionsRequest build() {
      QueryModuleVersionsRequest result = buildPartial();
    ...
    public QueryModuleVersionsRequest buildPartial() {
      QueryModuleVersionsRequest result = new QueryModuleVersionsRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryModuleVersionsRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryModuleVersionsRequest) {
        return mergeFrom((QueryModuleVersionsRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryModuleVersionsRequest other) {
      if (other == QueryModuleVersionsRequest.getDefaultInstance()) return this;
  ...
  private static final QueryModuleVersionsRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryModuleVersionsRequest();
  }
