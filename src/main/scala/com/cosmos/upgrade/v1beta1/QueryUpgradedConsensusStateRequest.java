 ...
 */
@Deprecated public final class QueryUpgradedConsensusStateRequest extends
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_cosmos_upgrade_v1beta1_QueryUpgradedConsensusStateRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_cosmos_upgrade_v1beta1_QueryUpgradedConsensusStateRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryUpgradedConsensusStateRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryUpgradedConsensusStateRequest other = (QueryUpgradedConsensusStateRequest) obj;
  ...
  public static QueryUpgradedConsensusStateRequest parseFrom(
  ...
  public static QueryUpgradedConsensusStateRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryUpgradedConsensusStateRequest parseFrom(
  ...
  public static QueryUpgradedConsensusStateRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryUpgradedConsensusStateRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryUpgradedConsensusStateRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryUpgradedConsensusStateRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public QueryUpgradedConsensusStateRequest build() {
      QueryUpgradedConsensusStateRequest result = buildPartial();
    ...
    public QueryUpgradedConsensusStateRequest buildPartial() {
      QueryUpgradedConsensusStateRequest result = new QueryUpgradedConsensusStateRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryUpgradedConsensusStateRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryUpgradedConsensusStateRequest) {
        return mergeFrom((QueryUpgradedConsensusStateRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryUpgradedConsensusStateRequest other) {
      if (other == QueryUpgradedConsensusStateRequest.getDefaultInstance()) return this;
  ...
  private static final QueryUpgradedConsensusStateRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryUpgradedConsensusStateRequest();
  }
