...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return UpgradeProto.internal_static_cosmos_upgrade_v1beta1_ModuleVersion_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return UpgradeProto.internal_static_cosmos_upgrade_v1beta1_ModuleVersion_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            ModuleVersion.class, Builder.class);
  }
  ...
  public static ModuleVersion parseFrom(
  ...
  public static ModuleVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static ModuleVersion parseFrom(
  ...
  public static ModuleVersion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static ModuleVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static ModuleVersion parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(ModuleVersion prototype) {
  ...
  public static final class Builder extends
    ...
    public ModuleVersion build() {
      ModuleVersion result = buildPartial();
    ...
    public ModuleVersion buildPartial() {
      ModuleVersion result = new ModuleVersion(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(ModuleVersion result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof ModuleVersion) {
        return mergeFrom((ModuleVersion)other);
      } else {
    ...
    public Builder mergeFrom(ModuleVersion other) {
      if (other == ModuleVersion.getDefaultInstance()) return this;
  ...
  private static final ModuleVersion DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ModuleVersion();
  }
