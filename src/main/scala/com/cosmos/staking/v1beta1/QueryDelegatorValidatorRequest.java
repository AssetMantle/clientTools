...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_cosmos_staking_v1beta1_QueryDelegatorValidatorRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_cosmos_staking_v1beta1_QueryDelegatorValidatorRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryDelegatorValidatorRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryDelegatorValidatorRequest other = (QueryDelegatorValidatorRequest) obj;
  ...
  public static QueryDelegatorValidatorRequest parseFrom(
  ...
  public static QueryDelegatorValidatorRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryDelegatorValidatorRequest parseFrom(
  ...
  public static QueryDelegatorValidatorRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryDelegatorValidatorRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryDelegatorValidatorRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryDelegatorValidatorRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public QueryDelegatorValidatorRequest build() {
      QueryDelegatorValidatorRequest result = buildPartial();
    ...
    public QueryDelegatorValidatorRequest buildPartial() {
      QueryDelegatorValidatorRequest result = new QueryDelegatorValidatorRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryDelegatorValidatorRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryDelegatorValidatorRequest) {
        return mergeFrom((QueryDelegatorValidatorRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryDelegatorValidatorRequest other) {
      if (other == QueryDelegatorValidatorRequest.getDefaultInstance()) return this;
  ...
  private static final QueryDelegatorValidatorRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryDelegatorValidatorRequest();
  }
