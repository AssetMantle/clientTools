...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_cosmos_staking_v1beta1_QueryDelegatorDelegationsRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_cosmos_staking_v1beta1_QueryDelegatorDelegationsRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryDelegatorDelegationsRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryDelegatorDelegationsRequest other = (QueryDelegatorDelegationsRequest) obj;
  ...
  public static QueryDelegatorDelegationsRequest parseFrom(
  ...
  public static QueryDelegatorDelegationsRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryDelegatorDelegationsRequest parseFrom(
  ...
  public static QueryDelegatorDelegationsRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryDelegatorDelegationsRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryDelegatorDelegationsRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryDelegatorDelegationsRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public QueryDelegatorDelegationsRequest build() {
      QueryDelegatorDelegationsRequest result = buildPartial();
    ...
    public QueryDelegatorDelegationsRequest buildPartial() {
      QueryDelegatorDelegationsRequest result = new QueryDelegatorDelegationsRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryDelegatorDelegationsRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryDelegatorDelegationsRequest) {
        return mergeFrom((QueryDelegatorDelegationsRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryDelegatorDelegationsRequest other) {
      if (other == QueryDelegatorDelegationsRequest.getDefaultInstance()) return this;
  ...
  private static final QueryDelegatorDelegationsRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryDelegatorDelegationsRequest();
  }
