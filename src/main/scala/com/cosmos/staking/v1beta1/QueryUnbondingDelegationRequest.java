...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_cosmos_staking_v1beta1_QueryUnbondingDelegationRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_cosmos_staking_v1beta1_QueryUnbondingDelegationRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryUnbondingDelegationRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryUnbondingDelegationRequest other = (QueryUnbondingDelegationRequest) obj;
  ...
  public static QueryUnbondingDelegationRequest parseFrom(
  ...
  public static QueryUnbondingDelegationRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryUnbondingDelegationRequest parseFrom(
  ...
  public static QueryUnbondingDelegationRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryUnbondingDelegationRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryUnbondingDelegationRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryUnbondingDelegationRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public QueryUnbondingDelegationRequest build() {
      QueryUnbondingDelegationRequest result = buildPartial();
    ...
    public QueryUnbondingDelegationRequest buildPartial() {
      QueryUnbondingDelegationRequest result = new QueryUnbondingDelegationRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryUnbondingDelegationRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryUnbondingDelegationRequest) {
        return mergeFrom((QueryUnbondingDelegationRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryUnbondingDelegationRequest other) {
      if (other == QueryUnbondingDelegationRequest.getDefaultInstance()) return this;
  ...
  private static final QueryUnbondingDelegationRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryUnbondingDelegationRequest();
  }
