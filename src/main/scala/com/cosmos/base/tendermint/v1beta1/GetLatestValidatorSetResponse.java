...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_cosmos_base_tendermint_v1beta1_GetLatestValidatorSetResponse_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_cosmos_base_tendermint_v1beta1_GetLatestValidatorSetResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            GetLatestValidatorSetResponse.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    GetLatestValidatorSetResponse other = (GetLatestValidatorSetResponse) obj;
  ...
  public static GetLatestValidatorSetResponse parseFrom(
  ...
  public static GetLatestValidatorSetResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static GetLatestValidatorSetResponse parseFrom(
  ...
  public static GetLatestValidatorSetResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static GetLatestValidatorSetResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static GetLatestValidatorSetResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(GetLatestValidatorSetResponse prototype) {
  ...
  public static final class Builder extends
    ...
    public GetLatestValidatorSetResponse build() {
      GetLatestValidatorSetResponse result = buildPartial();
    ...
    public GetLatestValidatorSetResponse buildPartial() {
      GetLatestValidatorSetResponse result = new GetLatestValidatorSetResponse(this);
    ...
    private void buildPartialRepeatedFields(GetLatestValidatorSetResponse result) {
      if (validatorsBuilder_ == null) {
    ...
    private void buildPartial0(GetLatestValidatorSetResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof GetLatestValidatorSetResponse) {
        return mergeFrom((GetLatestValidatorSetResponse)other);
      } else {
    ...
    public Builder mergeFrom(GetLatestValidatorSetResponse other) {
      if (other == GetLatestValidatorSetResponse.getDefaultInstance()) return this;
  ...
  private static final GetLatestValidatorSetResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GetLatestValidatorSetResponse();
  }
