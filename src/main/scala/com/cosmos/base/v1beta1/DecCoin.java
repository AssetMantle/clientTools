...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return CoinProto.internal_static_cosmos_base_v1beta1_DecCoin_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return CoinProto.internal_static_cosmos_base_v1beta1_DecCoin_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            DecCoin.class, Builder.class);
  }
  ...
  public static DecCoin parseFrom(
  ...
  public static DecCoin parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static DecCoin parseFrom(
  ...
  public static DecCoin parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static DecCoin parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static DecCoin parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(DecCoin prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public DecCoin getDefaultInstanceForType() {
      return DecCoin.getDefaultInstance();
    }

    @Override
    public DecCoin build() {
      DecCoin result = buildPartial();
    ...
    @Override
    public DecCoin buildPartial() {
      DecCoin result = new DecCoin(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(DecCoin result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof DecCoin) {
        return mergeFrom((DecCoin)other);
      } else {
    ...
    public Builder mergeFrom(DecCoin other) {
      if (other == DecCoin.getDefaultInstance()) return this;
  ...
  private static final DecCoin DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new DecCoin();
  }
