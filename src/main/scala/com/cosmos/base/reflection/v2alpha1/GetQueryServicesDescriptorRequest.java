...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ReflectionProto.internal_static_cosmos_base_reflection_v2alpha1_GetQueryServicesDescriptorRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ReflectionProto.internal_static_cosmos_base_reflection_v2alpha1_GetQueryServicesDescriptorRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            GetQueryServicesDescriptorRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof GetQueryServicesDescriptorRequest)) {
      return super.equals(obj);
    }
    GetQueryServicesDescriptorRequest other = (GetQueryServicesDescriptorRequest) obj;
  ...
  public static GetQueryServicesDescriptorRequest parseFrom(
  ...
  public static GetQueryServicesDescriptorRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static GetQueryServicesDescriptorRequest parseFrom(
  ...
  public static GetQueryServicesDescriptorRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static GetQueryServicesDescriptorRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static GetQueryServicesDescriptorRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(GetQueryServicesDescriptorRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public GetQueryServicesDescriptorRequest build() {
      GetQueryServicesDescriptorRequest result = buildPartial();
    ...
    public GetQueryServicesDescriptorRequest buildPartial() {
      GetQueryServicesDescriptorRequest result = new GetQueryServicesDescriptorRequest(this);
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof GetQueryServicesDescriptorRequest) {
        return mergeFrom((GetQueryServicesDescriptorRequest)other);
      } else {
    ...
    public Builder mergeFrom(GetQueryServicesDescriptorRequest other) {
      if (other == GetQueryServicesDescriptorRequest.getDefaultInstance()) return this;
  ...
  private static final GetQueryServicesDescriptorRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GetQueryServicesDescriptorRequest();
  }
