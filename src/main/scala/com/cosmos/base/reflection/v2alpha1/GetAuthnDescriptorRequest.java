...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ReflectionProto.internal_static_cosmos_base_reflection_v2alpha1_GetAuthnDescriptorRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ReflectionProto.internal_static_cosmos_base_reflection_v2alpha1_GetAuthnDescriptorRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            GetAuthnDescriptorRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof GetAuthnDescriptorRequest)) {
      return super.equals(obj);
    }
    GetAuthnDescriptorRequest other = (GetAuthnDescriptorRequest) obj;
  ...
  public static GetAuthnDescriptorRequest parseFrom(
  ...
  public static GetAuthnDescriptorRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static GetAuthnDescriptorRequest parseFrom(
  ...
  public static GetAuthnDescriptorRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static GetAuthnDescriptorRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static GetAuthnDescriptorRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(GetAuthnDescriptorRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public GetAuthnDescriptorRequest build() {
      GetAuthnDescriptorRequest result = buildPartial();
    ...
    public GetAuthnDescriptorRequest buildPartial() {
      GetAuthnDescriptorRequest result = new GetAuthnDescriptorRequest(this);
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof GetAuthnDescriptorRequest) {
        return mergeFrom((GetAuthnDescriptorRequest)other);
      } else {
    ...
    public Builder mergeFrom(GetAuthnDescriptorRequest other) {
      if (other == GetAuthnDescriptorRequest.getDefaultInstance()) return this;
  ...
  private static final GetAuthnDescriptorRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GetAuthnDescriptorRequest();
  }
