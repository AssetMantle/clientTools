...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_cosmos_bank_v1beta1_QuerySupplyOfRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_cosmos_bank_v1beta1_QuerySupplyOfRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QuerySupplyOfRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QuerySupplyOfRequest other = (QuerySupplyOfRequest) obj;
  ...
  public static QuerySupplyOfRequest parseFrom(
  ...
  public static QuerySupplyOfRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QuerySupplyOfRequest parseFrom(
  ...
  public static QuerySupplyOfRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QuerySupplyOfRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QuerySupplyOfRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QuerySupplyOfRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public QuerySupplyOfRequest build() {
      QuerySupplyOfRequest result = buildPartial();
    ...
    public QuerySupplyOfRequest buildPartial() {
      QuerySupplyOfRequest result = new QuerySupplyOfRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QuerySupplyOfRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QuerySupplyOfRequest) {
        return mergeFrom((QuerySupplyOfRequest)other);
      } else {
    ...
    public Builder mergeFrom(QuerySupplyOfRequest other) {
      if (other == QuerySupplyOfRequest.getDefaultInstance()) return this;
  ...
  private static final QuerySupplyOfRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QuerySupplyOfRequest();
  }
