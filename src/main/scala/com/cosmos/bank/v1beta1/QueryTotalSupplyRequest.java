...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_cosmos_bank_v1beta1_QueryTotalSupplyRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_cosmos_bank_v1beta1_QueryTotalSupplyRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryTotalSupplyRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryTotalSupplyRequest other = (QueryTotalSupplyRequest) obj;
  ...
  public static QueryTotalSupplyRequest parseFrom(
  ...
  public static QueryTotalSupplyRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryTotalSupplyRequest parseFrom(
  ...
  public static QueryTotalSupplyRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryTotalSupplyRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryTotalSupplyRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryTotalSupplyRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public QueryTotalSupplyRequest build() {
      QueryTotalSupplyRequest result = buildPartial();
    ...
    public QueryTotalSupplyRequest buildPartial() {
      QueryTotalSupplyRequest result = new QueryTotalSupplyRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryTotalSupplyRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryTotalSupplyRequest) {
        return mergeFrom((QueryTotalSupplyRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryTotalSupplyRequest other) {
      if (other == QueryTotalSupplyRequest.getDefaultInstance()) return this;
  ...
  private static final QueryTotalSupplyRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryTotalSupplyRequest();
  }
