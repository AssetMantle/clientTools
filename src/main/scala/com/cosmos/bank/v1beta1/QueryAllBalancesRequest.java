...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_cosmos_bank_v1beta1_QueryAllBalancesRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_cosmos_bank_v1beta1_QueryAllBalancesRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryAllBalancesRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryAllBalancesRequest other = (QueryAllBalancesRequest) obj;
  ...
  public static QueryAllBalancesRequest parseFrom(
  ...
  public static QueryAllBalancesRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryAllBalancesRequest parseFrom(
  ...
  public static QueryAllBalancesRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryAllBalancesRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryAllBalancesRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryAllBalancesRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public QueryAllBalancesRequest build() {
      QueryAllBalancesRequest result = buildPartial();
    ...
    public QueryAllBalancesRequest buildPartial() {
      QueryAllBalancesRequest result = new QueryAllBalancesRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryAllBalancesRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryAllBalancesRequest) {
        return mergeFrom((QueryAllBalancesRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryAllBalancesRequest other) {
      if (other == QueryAllBalancesRequest.getDefaultInstance()) return this;
  ...
  private static final QueryAllBalancesRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryAllBalancesRequest();
  }
