...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_cosmos_authz_v1beta1_QueryGranteeGrantsRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_cosmos_authz_v1beta1_QueryGranteeGrantsRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryGranteeGrantsRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryGranteeGrantsRequest other = (QueryGranteeGrantsRequest) obj;
  ...
  public static QueryGranteeGrantsRequest parseFrom(
  ...
  public static QueryGranteeGrantsRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryGranteeGrantsRequest parseFrom(
  ...
  public static QueryGranteeGrantsRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryGranteeGrantsRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryGranteeGrantsRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryGranteeGrantsRequest prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public QueryGranteeGrantsRequest getDefaultInstanceForType() {
      return QueryGranteeGrantsRequest.getDefaultInstance();
    }

    @Override
    public QueryGranteeGrantsRequest build() {
      QueryGranteeGrantsRequest result = buildPartial();
    ...
    @Override
    public QueryGranteeGrantsRequest buildPartial() {
      QueryGranteeGrantsRequest result = new QueryGranteeGrantsRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryGranteeGrantsRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryGranteeGrantsRequest) {
        return mergeFrom((QueryGranteeGrantsRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryGranteeGrantsRequest other) {
      if (other == QueryGranteeGrantsRequest.getDefaultInstance()) return this;
  ...
  private static final QueryGranteeGrantsRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryGranteeGrantsRequest();
  }
