...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return EventProto.internal_static_cosmos_authz_v1beta1_EventGrant_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return EventProto.internal_static_cosmos_authz_v1beta1_EventGrant_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            EventGrant.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    EventGrant other = (EventGrant) obj;
  ...
  public static EventGrant parseFrom(
  ...
  public static EventGrant parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static EventGrant parseFrom(
  ...
  public static EventGrant parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static EventGrant parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static EventGrant parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(EventGrant prototype) {
  ...
  public static final class Builder extends
    ...
    public EventGrant build() {
      EventGrant result = buildPartial();
    ...
    public EventGrant buildPartial() {
      EventGrant result = new EventGrant(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(EventGrant result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof EventGrant) {
        return mergeFrom((EventGrant)other);
      } else {
    ...
    public Builder mergeFrom(EventGrant other) {
      if (other == EventGrant.getDefaultInstance()) return this;
  ...
  private static final EventGrant DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new EventGrant();
  }
