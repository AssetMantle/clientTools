...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_cosmos_distribution_v1beta1_QueryDelegatorWithdrawAddressRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_cosmos_distribution_v1beta1_QueryDelegatorWithdrawAddressRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryDelegatorWithdrawAddressRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryDelegatorWithdrawAddressRequest other = (QueryDelegatorWithdrawAddressRequest) obj;
  ...
  public static QueryDelegatorWithdrawAddressRequest parseFrom(
  ...
  public static QueryDelegatorWithdrawAddressRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryDelegatorWithdrawAddressRequest parseFrom(
  ...
  public static QueryDelegatorWithdrawAddressRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryDelegatorWithdrawAddressRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryDelegatorWithdrawAddressRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryDelegatorWithdrawAddressRequest prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public QueryDelegatorWithdrawAddressRequest getDefaultInstanceForType() {
      return QueryDelegatorWithdrawAddressRequest.getDefaultInstance();
    }

    @Override
    public QueryDelegatorWithdrawAddressRequest build() {
      QueryDelegatorWithdrawAddressRequest result = buildPartial();
    ...
    @Override
    public QueryDelegatorWithdrawAddressRequest buildPartial() {
      QueryDelegatorWithdrawAddressRequest result = new QueryDelegatorWithdrawAddressRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryDelegatorWithdrawAddressRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryDelegatorWithdrawAddressRequest) {
        return mergeFrom((QueryDelegatorWithdrawAddressRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryDelegatorWithdrawAddressRequest other) {
      if (other == QueryDelegatorWithdrawAddressRequest.getDefaultInstance()) return this;
  ...
  private static final QueryDelegatorWithdrawAddressRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryDelegatorWithdrawAddressRequest();
  }
