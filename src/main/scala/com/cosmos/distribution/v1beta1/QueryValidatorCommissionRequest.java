...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_cosmos_distribution_v1beta1_QueryValidatorCommissionRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_cosmos_distribution_v1beta1_QueryValidatorCommissionRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryValidatorCommissionRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryValidatorCommissionRequest other = (QueryValidatorCommissionRequest) obj;
  ...
  public static QueryValidatorCommissionRequest parseFrom(
  ...
  public static QueryValidatorCommissionRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryValidatorCommissionRequest parseFrom(
  ...
  public static QueryValidatorCommissionRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryValidatorCommissionRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryValidatorCommissionRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryValidatorCommissionRequest prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public QueryValidatorCommissionRequest getDefaultInstanceForType() {
      return QueryValidatorCommissionRequest.getDefaultInstance();
    }

    @Override
    public QueryValidatorCommissionRequest build() {
      QueryValidatorCommissionRequest result = buildPartial();
    ...
    @Override
    public QueryValidatorCommissionRequest buildPartial() {
      QueryValidatorCommissionRequest result = new QueryValidatorCommissionRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryValidatorCommissionRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryValidatorCommissionRequest) {
        return mergeFrom((QueryValidatorCommissionRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryValidatorCommissionRequest other) {
      if (other == QueryValidatorCommissionRequest.getDefaultInstance()) return this;
  ...
  private static final QueryValidatorCommissionRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryValidatorCommissionRequest();
  }
