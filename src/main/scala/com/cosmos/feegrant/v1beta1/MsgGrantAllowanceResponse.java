...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return TxProto.internal_static_cosmos_feegrant_v1beta1_MsgGrantAllowanceResponse_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return TxProto.internal_static_cosmos_feegrant_v1beta1_MsgGrantAllowanceResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            MsgGrantAllowanceResponse.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    MsgGrantAllowanceResponse other = (MsgGrantAllowanceResponse) obj;
  ...
  public static MsgGrantAllowanceResponse parseFrom(
  ...
  public static MsgGrantAllowanceResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static MsgGrantAllowanceResponse parseFrom(
  ...
  public static MsgGrantAllowanceResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static MsgGrantAllowanceResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static MsgGrantAllowanceResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(MsgGrantAllowanceResponse prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public MsgGrantAllowanceResponse getDefaultInstanceForType() {
      return MsgGrantAllowanceResponse.getDefaultInstance();
    }

    @Override
    public MsgGrantAllowanceResponse build() {
      MsgGrantAllowanceResponse result = buildPartial();
    ...
    @Override
    public MsgGrantAllowanceResponse buildPartial() {
      MsgGrantAllowanceResponse result = new MsgGrantAllowanceResponse(this);
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof MsgGrantAllowanceResponse) {
        return mergeFrom((MsgGrantAllowanceResponse)other);
      } else {
    ...
    public Builder mergeFrom(MsgGrantAllowanceResponse other) {
      if (other == MsgGrantAllowanceResponse.getDefaultInstance()) return this;
  ...
  private static final MsgGrantAllowanceResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new MsgGrantAllowanceResponse();
  }
