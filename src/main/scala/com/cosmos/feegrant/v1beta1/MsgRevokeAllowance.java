...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return TxProto.internal_static_cosmos_feegrant_v1beta1_MsgRevokeAllowance_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return TxProto.internal_static_cosmos_feegrant_v1beta1_MsgRevokeAllowance_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            MsgRevokeAllowance.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    MsgRevokeAllowance other = (MsgRevokeAllowance) obj;
  ...
  public static MsgRevokeAllowance parseFrom(
  ...
  public static MsgRevokeAllowance parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static MsgRevokeAllowance parseFrom(
  ...
  public static MsgRevokeAllowance parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static MsgRevokeAllowance parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static MsgRevokeAllowance parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(MsgRevokeAllowance prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public MsgRevokeAllowance getDefaultInstanceForType() {
      return MsgRevokeAllowance.getDefaultInstance();
    }

    @Override
    public MsgRevokeAllowance build() {
      MsgRevokeAllowance result = buildPartial();
    ...
    @Override
    public MsgRevokeAllowance buildPartial() {
      MsgRevokeAllowance result = new MsgRevokeAllowance(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(MsgRevokeAllowance result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof MsgRevokeAllowance) {
        return mergeFrom((MsgRevokeAllowance)other);
      } else {
    ...
    public Builder mergeFrom(MsgRevokeAllowance other) {
      if (other == MsgRevokeAllowance.getDefaultInstance()) return this;
  ...
  private static final MsgRevokeAllowance DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new MsgRevokeAllowance();
  }
