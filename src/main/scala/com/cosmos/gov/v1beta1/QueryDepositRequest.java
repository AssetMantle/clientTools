...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_cosmos_gov_v1beta1_QueryDepositRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_cosmos_gov_v1beta1_QueryDepositRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryDepositRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryDepositRequest other = (QueryDepositRequest) obj;
  ...
  public static QueryDepositRequest parseFrom(
  ...
  public static QueryDepositRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryDepositRequest parseFrom(
  ...
  public static QueryDepositRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryDepositRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryDepositRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryDepositRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public QueryDepositRequest build() {
      QueryDepositRequest result = buildPartial();
    ...
    public QueryDepositRequest buildPartial() {
      QueryDepositRequest result = new QueryDepositRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryDepositRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryDepositRequest) {
        return mergeFrom((QueryDepositRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryDepositRequest other) {
      if (other == QueryDepositRequest.getDefaultInstance()) return this;
  ...
  private static final QueryDepositRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryDepositRequest();
  }
