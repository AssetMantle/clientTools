...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return GovProto.internal_static_cosmos_gov_v1beta1_VotingParams_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return GovProto.internal_static_cosmos_gov_v1beta1_VotingParams_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            VotingParams.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    VotingParams other = (VotingParams) obj;
  ...
  public static VotingParams parseFrom(
  ...
  public static VotingParams parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static VotingParams parseFrom(
  ...
  public static VotingParams parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static VotingParams parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static VotingParams parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(VotingParams prototype) {
  ...
  public static final class Builder extends
    ...
    public VotingParams build() {
      VotingParams result = buildPartial();
    ...
    public VotingParams buildPartial() {
      VotingParams result = new VotingParams(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(VotingParams result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof VotingParams) {
        return mergeFrom((VotingParams)other);
      } else {
    ...
    public Builder mergeFrom(VotingParams other) {
      if (other == VotingParams.getDefaultInstance()) return this;
  ...
  private static final VotingParams DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new VotingParams();
  }
