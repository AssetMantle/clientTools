...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return QueryProto.internal_static_cosmos_gov_v1beta1_QueryProposalRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return QueryProto.internal_static_cosmos_gov_v1beta1_QueryProposalRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryProposalRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    QueryProposalRequest other = (QueryProposalRequest) obj;
  ...
  public static QueryProposalRequest parseFrom(
  ...
  public static QueryProposalRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryProposalRequest parseFrom(
  ...
  public static QueryProposalRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryProposalRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryProposalRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryProposalRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public QueryProposalRequest build() {
      QueryProposalRequest result = buildPartial();
    ...
    public QueryProposalRequest buildPartial() {
      QueryProposalRequest result = new QueryProposalRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(QueryProposalRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryProposalRequest) {
        return mergeFrom((QueryProposalRequest)other);
      } else {
    ...
    public Builder mergeFrom(QueryProposalRequest other) {
      if (other == QueryProposalRequest.getDefaultInstance()) return this;
  ...
  private static final QueryProposalRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryProposalRequest();
  }
