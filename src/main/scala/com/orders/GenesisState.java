...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.orders.GenesisStateV1Proto.internal_static_orders_GenesisState_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.orders.GenesisStateV1Proto.internal_static_orders_GenesisState_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.orders.GenesisState.class, com.orders.GenesisState.Builder.class);
  }

  public static final int MAPPABLES_FIELD_NUMBER = 1;
  @SuppressWarnings("serial")
  private java.util.List<com.orders.Mappable> mappables_;
  /**
   * <code>repeated .orders.Mappable mappables = 1 [json_name = "mappables"];</code>
   */
  @java.lang.Override
  public java.util.List<com.orders.Mappable> getMappablesList() {
    return mappables_;
  }
  /**
   * <code>repeated .orders.Mappable mappables = 1 [json_name = "mappables"];</code>
   */
  @java.lang.Override
  public java.util.List<? extends com.orders.MappableOrBuilder> 
   ...
   */
  @java.lang.Override
  public com.orders.Mappable getMappables(int index) {
   ...
   */
  @java.lang.Override
  public com.orders.MappableOrBuilder getMappablesOrBuilder(
      int index) {
    return mappables_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.orders.GenesisState)) {
      return super.equals(obj);
    }
    com.orders.GenesisState other = (com.orders.GenesisState) obj;
  ...
  public static com.orders.GenesisState parseFrom(
  ...
  public static com.orders.GenesisState parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.orders.GenesisState parseFrom(
  ...
  public static com.orders.GenesisState parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.orders.GenesisState parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.orders.GenesisState parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.orders.GenesisState prototype) {
  ...
  public static final class Builder extends
      ...
      com.orders.GenesisStateOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.orders.GenesisStateV1Proto.internal_static_orders_GenesisState_descriptor;
    }
    ...
    // Construct using com.orders.GenesisState.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.orders.GenesisState getDefaultInstanceForType() {
      return com.orders.GenesisState.getDefaultInstance();
    }

    @java.lang.Override
    public com.orders.GenesisState build() {
      com.orders.GenesisState result = buildPartial();
    ...
    @java.lang.Override
    public com.orders.GenesisState buildPartial() {
      com.orders.GenesisState result = new com.orders.GenesisState(this);
    ...
    private void buildPartialRepeatedFields(com.orders.GenesisState result) {
      if (mappablesBuilder_ == null) {
    ...
    private void buildPartial0(com.orders.GenesisState result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.orders.GenesisState) {
        return mergeFrom((com.orders.GenesisState)other);
      } else {
    ...
    public Builder mergeFrom(com.orders.GenesisState other) {
      if (other == com.orders.GenesisState.getDefaultInstance()) return this;
      if (mappablesBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.orders.Mappable m =
                  input.readMessage(
                      com.orders.Mappable.parser(),
                      extensionRegistry);
              if (mappablesBuilder_ == null) {
                ensureMappablesIsMutable();
                mappables_.add(m);
    ...
    private void ensureMappablesIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        mappables_ = new java.util.ArrayList<com.orders.Mappable>(mappables_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.orders.Mappable, com.orders.Mappable.Builder, com.orders.MappableOrBuilder> mappablesBuilder_;
    ...
    public Builder setMappables(
        int index, com.orders.Mappable value) {
      if (mappablesBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setMappables(
        int index, com.orders.Mappable.Builder builderForValue) {
      if (mappablesBuilder_ == null) {
        ensureMappablesIsMutable();
     ...
     * <code>repeated .orders.Mappable mappables = 1 [json_name = "mappables"];</code>
     */
    public Builder addMappables(com.orders.Mappable value) {
      if (mappablesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addMappables(
        com.orders.Mappable.Builder builderForValue) {
      if (mappablesBuilder_ == null) {
        ensureMappablesIsMutable();
    ...
    public Builder addAllMappables(
        java.lang.Iterable<? extends com.orders.Mappable> values) {
      if (mappablesBuilder_ == null) {
        ensureMappablesIsMutable();
     ...
     * <code>repeated .orders.Mappable mappables = 1 [json_name = "mappables"];</code>
     */
    public com.orders.Mappable.Builder getMappablesBuilder(
        int index) {
     ...
     * <code>repeated .orders.Mappable mappables = 1 [json_name = "mappables"];</code>
     */
    public com.orders.Mappable.Builder addMappablesBuilder() {
      return getMappablesFieldBuilder().addBuilder(
          com.orders.Mappable.getDefaultInstance());
    }
    /**
     * <code>repeated .orders.Mappable mappables = 1 [json_name = "mappables"];</code>
     */
    public com.orders.Mappable.Builder addMappablesBuilder(
        int index) {
      return getMappablesFieldBuilder().addBuilder(
          index, com.orders.Mappable.getDefaultInstance());
    }
    /**
     * <code>repeated .orders.Mappable mappables = 1 [json_name = "mappables"];</code>
     */
    public java.util.List<com.orders.Mappable.Builder> 
         getMappablesBuilderList() {
      return getMappablesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.orders.Mappable, com.orders.Mappable.Builder, com.orders.MappableOrBuilder> 
  ...
  private static final com.orders.GenesisState DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.orders.GenesisState();
  }

  public static com.orders.GenesisState getDefaultInstance() {
