...
public final class MessageV1 {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return identities.transactions.quash.MessageV1.internal_static_identities_transactions_quash_Message_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return identities.transactions.quash.MessageV1.internal_static_identities_transactions_quash_Message_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              identities.transactions.quash.MessageV1.Message.class, identities.transactions.quash.MessageV1.Message.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof identities.transactions.quash.MessageV1.Message)) {
        return super.equals(obj);
      }
      identities.transactions.quash.MessageV1.Message other = (identities.transactions.quash.MessageV1.Message) obj;
    ...
    public static identities.transactions.quash.MessageV1.Message parseFrom(
    ...
    public static identities.transactions.quash.MessageV1.Message parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static identities.transactions.quash.MessageV1.Message parseFrom(
    ...
    public static identities.transactions.quash.MessageV1.Message parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static identities.transactions.quash.MessageV1.Message parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static identities.transactions.quash.MessageV1.Message parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(identities.transactions.quash.MessageV1.Message prototype) {
    ...
    public static final class Builder extends
        ...
        identities.transactions.quash.MessageV1.MessageOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return identities.transactions.quash.MessageV1.internal_static_identities_transactions_quash_Message_descriptor;
      }
      ...
      // Construct using identities.transactions.quash.MessageV1.Message.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public identities.transactions.quash.MessageV1.Message getDefaultInstanceForType() {
        return identities.transactions.quash.MessageV1.Message.getDefaultInstance();
      }

      @java.lang.Override
      public identities.transactions.quash.MessageV1.Message build() {
        identities.transactions.quash.MessageV1.Message result = buildPartial();
      ...
      @java.lang.Override
      public identities.transactions.quash.MessageV1.Message buildPartial() {
        identities.transactions.quash.MessageV1.Message result = new identities.transactions.quash.MessageV1.Message(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(identities.transactions.quash.MessageV1.Message result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof identities.transactions.quash.MessageV1.Message) {
          return mergeFrom((identities.transactions.quash.MessageV1.Message)other);
        } else {
      ...
      public Builder mergeFrom(identities.transactions.quash.MessageV1.Message other) {
        if (other == identities.transactions.quash.MessageV1.Message.getDefaultInstance()) return this;
    ...
    private static final identities.transactions.quash.MessageV1.Message DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new identities.transactions.quash.MessageV1.Message();
    }

    public static identities.transactions.quash.MessageV1.Message getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ntity_i_d\030\003 \001(\0132\017.ids.IdentityIDb\006proto3"
    };
