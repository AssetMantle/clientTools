...
public final class MessageV1 {
  ...
  public interface MessageOrBuilder extends
      // @@protoc_insertion_point(interface_extends:identities.transactions.deputize.Message)
  ...
  /**
   * Protobuf type {@code identities.transactions.deputize.Message}
   */
  public static final class Message extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:identities.transactions.deputize.Message)
      MessageOrBuilder {
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return identities.transactions.deputize.MessageV1.internal_static_identities_transactions_deputize_Message_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return identities.transactions.deputize.MessageV1.internal_static_identities_transactions_deputize_Message_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              identities.transactions.deputize.MessageV1.Message.class, identities.transactions.deputize.MessageV1.Message.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof identities.transactions.deputize.MessageV1.Message)) {
        return super.equals(obj);
      }
      identities.transactions.deputize.MessageV1.Message other = (identities.transactions.deputize.MessageV1.Message) obj;
    ...
    public static identities.transactions.deputize.MessageV1.Message parseFrom(
    ...
    public static identities.transactions.deputize.MessageV1.Message parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static identities.transactions.deputize.MessageV1.Message parseFrom(
    ...
    public static identities.transactions.deputize.MessageV1.Message parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static identities.transactions.deputize.MessageV1.Message parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static identities.transactions.deputize.MessageV1.Message parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(identities.transactions.deputize.MessageV1.Message prototype) {
    ...
    public static final class Builder extends
        ...
        // @@protoc_insertion_point(builder_implements:identities.transactions.deputize.Message)
        identities.transactions.deputize.MessageV1.MessageOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return identities.transactions.deputize.MessageV1.internal_static_identities_transactions_deputize_Message_descriptor;
      }
      ...
      // Construct using identities.transactions.deputize.MessageV1.Message.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public identities.transactions.deputize.MessageV1.Message getDefaultInstanceForType() {
        return identities.transactions.deputize.MessageV1.Message.getDefaultInstance();
      }

      @java.lang.Override
      public identities.transactions.deputize.MessageV1.Message build() {
        identities.transactions.deputize.MessageV1.Message result = buildPartial();
      ...
      @java.lang.Override
      public identities.transactions.deputize.MessageV1.Message buildPartial() {
        identities.transactions.deputize.MessageV1.Message result = new identities.transactions.deputize.MessageV1.Message(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(identities.transactions.deputize.MessageV1.Message result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof identities.transactions.deputize.MessageV1.Message) {
          return mergeFrom((identities.transactions.deputize.MessageV1.Message)other);
        } else {
      ...
      public Builder mergeFrom(identities.transactions.deputize.MessageV1.Message other) {
        if (other == identities.transactions.deputize.MessageV1.Message.getDefaultInstance()) return this;
      ...
      // @@protoc_insertion_point(builder_scope:identities.transactions.deputize.Message)
    }

    // @@protoc_insertion_point(class_scope:identities.transactions.deputize.Message)
    private static final identities.transactions.deputize.MessageV1.Message DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new identities.transactions.deputize.MessageV1.Message();
    }

    public static identities.transactions.deputize.MessageV1.Message getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "e/propertyList.v1.proto\"\352\002\n\007Message\022\014\n\004f" +
      "rom\030\001 \001(\t\022!\n\010from_i_d\030\002 \001(\0132\017.ids.Identi" +
      "tyID\022\037\n\006to_i_d\030\003 \001(\0132\017.ids.IdentityID\0221\n" +
      "\022classification_i_d\030\004 \001(\0132\025.ids.Classifi" +
      "cationID\0222\n\025maintained_properties\030\005 \001(\0132" +
      "\023.lists.PropertyList\022\026\n\016can_mint_asset\030\006" +
      " \001(\010\022\026\n\016can_burn_asset\030\007 \001(\010\022\034\n\024can_renu" +
      "merate_asset\030\010 \001(\010\022\032\n\022can_add_maintainer" +
      "\030\t \001(\010\022\035\n\025can_remove_maintainer\030\n \001(\010\022\035\n" +
      "\025can_mutate_maintainer\030\013 \001(\010b\006proto3"
    };
