...
import data.{AccAddressDataV1, AnyDataV1, SuperData}
import ids.base.{DataID, HashID, StringID}

case class AccAddressData(value: Array[Byte]) extends SuperData {
  ...
  def zeroValue: SuperData = AccAddressData(new Array[Byte](0))
