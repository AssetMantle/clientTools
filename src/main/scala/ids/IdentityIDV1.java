...
public final class IdentityIDV1 {
  private IdentityIDV1() {}
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ids.IdentityIDV1.internal_static_ids_IdentityID_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ids.IdentityIDV1.internal_static_ids_IdentityID_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ids.IdentityIDV1.IdentityID.class, ids.IdentityIDV1.IdentityID.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ids.IdentityIDV1.IdentityID)) {
        return super.equals(obj);
      }
      ids.IdentityIDV1.IdentityID other = (ids.IdentityIDV1.IdentityID) obj;
    ...
    public static ids.IdentityIDV1.IdentityID parseFrom(
    ...
    public static ids.IdentityIDV1.IdentityID parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ids.IdentityIDV1.IdentityID parseFrom(
    ...
    public static ids.IdentityIDV1.IdentityID parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ids.IdentityIDV1.IdentityID parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ids.IdentityIDV1.IdentityID parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ids.IdentityIDV1.IdentityID prototype) {
    ...
    public static final class Builder extends
        ...
        ids.IdentityIDV1.IdentityIDOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ids.IdentityIDV1.internal_static_ids_IdentityID_descriptor;
      }
      ...
      // Construct using ids.IdentityIDV1.IdentityID.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public ids.IdentityIDV1.IdentityID getDefaultInstanceForType() {
        return ids.IdentityIDV1.IdentityID.getDefaultInstance();
      }

      @java.lang.Override
      public ids.IdentityIDV1.IdentityID build() {
        ids.IdentityIDV1.IdentityID result = buildPartial();
      ...
      @java.lang.Override
      public ids.IdentityIDV1.IdentityID buildPartial() {
        ids.IdentityIDV1.IdentityID result = new ids.IdentityIDV1.IdentityID(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(ids.IdentityIDV1.IdentityID result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ids.IdentityIDV1.IdentityID) {
          return mergeFrom((ids.IdentityIDV1.IdentityID)other);
        } else {
      ...
      public Builder mergeFrom(ids.IdentityIDV1.IdentityID other) {
        if (other == ids.IdentityIDV1.IdentityID.getDefaultInstance()) return this;
        if (other.hasHashID()) {
    ...
    private static final ids.IdentityIDV1.IdentityID DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ids.IdentityIDV1.IdentityID();
    }

    public static ids.IdentityIDV1.IdentityID getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "e/hashID.v1.proto\"1\n\nIdentityID\022\035\n\010hash_" +
      "i_d\030\001 \001(\0132\013.ids.HashID:\004\210\240\037\000b\006proto3"
    };
